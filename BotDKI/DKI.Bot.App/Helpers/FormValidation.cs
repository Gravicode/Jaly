...
namespace DKI.Bot.App.Helpers
{
    ...
    public class FormValidation
    {
        ...
        */
        ...
        public static bool isValidPhoneNumber(string field)
        {
            bool ret = false;
            try
            {
                ...
                ret = reg.IsMatch(field);
            }
            catch { ret = false; }
            return ret;
        }
        public static bool isValidNumeric(string field)
        {
            bool ret = false;
            try
            {
                ...
                decimal tmp = 0;
                CultureInfo culture = new CultureInfo(_locale);
                ret = decimal.TryParse(field, NumberStyles.Number, culture, out tmp);
            }
            catch { ret = false; }
            return ret;
        }
